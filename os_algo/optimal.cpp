...
void printCurrFrames(int item, int frame_items[], 
	int frame_occupied, int max_frames) {
...
void optimalPage(int ref_str[], int refStrLen, 
	int frame_items[], int max_frames) {
